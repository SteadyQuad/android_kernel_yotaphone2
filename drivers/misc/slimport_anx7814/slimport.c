...
//static int slimport7816_dvdd_power(unsigned int onoff); // slimport changes
...
void hardware_power_ctl(unchar);
...
static int anx7816_parse_dt(
	struct device *dev, struct anx7816_platform_data *pdata, struct anx7816_data *anx7816)
{
	int rc = 0;
	struct device_node *np = dev->of_node;
	struct platform_device *hdmi_pdev = NULL; // slimport changes
	struct device_node *hdmi_tx_node = NULL; // slimport changes
...
//	pdata->dvdd_power = slimport7816_dvdd_power; // Slimport changes
